...
export const queries = {
    Query: {
        ...
        getGames: async (r: unknown, r2: unknown, context: ContextWithUser, r4: any) => {
            // Jos kyselyssä kysytään user:ia -> parametriksi true -> user populoidaan.
            return await getGames(context.user.id, r4.fieldNodes[0].selectionSet.loc.source.body.includes('user {'))
        },
